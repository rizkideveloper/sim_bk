                            ...
                            <form action="/basisPermasalahan/{{ $basisPermasalahan->id }}" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    {{-- <div class="form-group">
                                        ...
                                        <input type="number" value="{{ $basisPermasalahan->bobot }}" name="bobot"
                                            class="form-control @error('bobot') is-invalid @enderror" id="InputBobot">
                                        @error('bobot')
                                            <small class="text-danger">
                                                {{ $message }}
                                            </small>
                                    ...
                                    <div class="form-group">
                                        <label for="InputBobot">Bobot</label>
                                        <select name="bobot" id="InputBobot" class="form-control @error('bobot') is-invalid @enderror">
                                            <option value="">Pilih Bobot</option>
                                            @foreach ($bobot as $key=>$item)
                                                <option value="{{ $item }}" {{ ($item == $basisPermasalahan->bobot)?"selected":"" }}>{{ $item }} - {{ $key }}</option>
                                            @endforeach
                                        </select>
                                        @error('bobot')
                                            <small class="text-danger">
