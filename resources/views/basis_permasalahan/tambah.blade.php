                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            <!-- form start -->
                            <form action="/basisPermasalahan" method="POST">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control @error('penanganan') is-invalid @enderror" name="penanganan" id="InputPenanganan"  rows="3" style="resize: none">{{ old('penanganan') }}</textarea>
                                        @error('penanganan')
                                            <small class="text-danger">
                                                {{ $message }}
                                            </small>
