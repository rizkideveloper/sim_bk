                            ...
                            <form action="/walikelas" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="{{ old('no_telp') }}" name="no_telp" class="form-control @error('no_telp') is-invalid @enderror" id="InputNoTelp">
                                        @error('no_telp')
                                            <small class="text-danger">
                                                {{ $message }}
                                            </small>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kelas_id" id="InputKelas" class="form-control @error('kelas_id') is-invalid @enderror">
                                            ...
                                            @foreach ($kelas as $item)
                                                <option value="{{ $item->id }}">{{ $item->nama }}-{{ $item->urutan }}-{{ $item->jurusan->nama }}</option>
                                            @endforeach
                                        </select>
                                        @error('kelas_id')
                                            <small class="text-danger">
