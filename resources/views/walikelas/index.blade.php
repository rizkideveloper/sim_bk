                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="/walikelas/create" class="btn btn-primary">Tambah</a>
                            ...
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="tableWalikelas" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>NIP</th>
                                    ...
                                    <tbody>
                                        @foreach ($walikelas as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/walikelas/{{ $item->walikelas_id }}/edit" class="btn btn-warning"><i
                                                            class="fas fa-pen "></i></a>
                                                    <form action="/walikelas/{{ $item->walikelas_id }}" method="post"
                                                        class="d-inline">
                                                        @method('delete')
                                                        @csrf
